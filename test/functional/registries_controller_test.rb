...
class RegistriesControllerTest < ActionController::TestCase
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post :create, registry: { client: @registry.client, entry: @registry.entry, exit: @registry.exit, obs: @registry.obs, phone: @registry.phone }
    end
  ...
  test "should update registry" do
    put :update, id: @registry, registry: { client: @registry.client, entry: @registry.entry, exit: @registry.exit, obs: @registry.obs, phone: @registry.phone }
    assert_redirected_to registry_path(assigns(:registry))
  end
